...
class LiveEditor extends React.Component{
    ...
    render(){
        ...
        return (
            ...
            <div>
            <Editor text={this.state.value} onChange={this.handleChange}/>
...
const helpText = `# Welcome to my React Markdown Previewer!
...
ReactDOM.render(<LiveEditor/>,document.getElementById('root'))
